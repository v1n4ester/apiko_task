...
import { getGoods, searchTextAC, getSearchedGoods, like, dislike } from '../../Redux/goods-reducer'
...
export default connect(mapStateToProps, {getGoods, searchTextAC, getSearchedGoods, like, dislike})(Main) 